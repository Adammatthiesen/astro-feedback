import { db, Websites, FeedbackCategories, Feedback, AdminUsers } from 'astro:db';
...
export default async function seed() {
  ...
  const categories = await db.insert(FeedbackCategories).values([
    {
      websiteId,
      name: 'Bug Report',
      slug: 'bug',
  ...
  await db.insert(Feedback).values([
    {
      ...
      description: 'When I try to click the login button on mobile devices, nothing happens. This issue occurs on both iOS and Android.',
    ...
    },
    {
      ...
      description: 'It would be great to have a dark mode option for better user experience during night time browsing.',
    ...
    },
    {
      ...
      description: 'I love the new design of your website. It looks modern and is very easy to navigate.',
